...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~cNat1phx7GgJO5Rfs8sg", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "243891908709", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
PACK_AUTHOR: process.env.PACK_AUTHOR || "KAS 𝐓𝐄𝐂𝐇", // Added // Input Yours custom...
